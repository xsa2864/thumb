...
<link href="/thumb/Public/dwz/themes/default/style.css" rel="stylesheet" type="text/css" media="screen"/>
<link href="/thumb/Public/dwz/themes/css/core.css" rel="stylesheet" type="text/css" media="screen"/>
<link href="/thumb/Public/dwz/themes/css/print.css" rel="stylesheet" type="text/css" media="print"/>
<link href="/thumb/Public/dwz/uploadify/css/uploadify.css" rel="stylesheet" type="text/css" media="screen"/>
<!--[if IE]>
<link href="/thumb/Public/dwz/themes/css/ieHack.css" rel="stylesheet" type="text/css" media="screen"/>
<![endif]-->

<!--[if lt IE 9]><script src="/thumb/Public/dwz/js/speedup.js" type="text/javascript"></script><script src="/thumb/Public/dwz/js/jquery-1.11.3.min.js" type="text/javascript"></script><![endif]-->
<!--[if gte IE 9]><!--><script src="/thumb/Public/dwz/js/jquery-2.1.4.min.js" type="text/javascript"></script><!--<![endif]-->

<script src="/thumb/Public/dwz/js/jquery.cookie.js" type="text/javascript"></script>
<script src="/thumb/Public/dwz/js/jquery.validate.js" type="text/javascript"></script>
<script src="/thumb/Public/dwz/js/jquery.bgiframe.js" type="text/javascript"></script>
<script src="/thumb/Public/dwz/xheditor/xheditor-1.2.2.min.js" type="text/javascript"></script>
<script src="/thumb/Public/dwz/xheditor/xheditor_lang/zh-cn.js" type="text/javascript"></script>
<script src="/thumb/Public/dwz/uploadify/scripts/jquery.uploadify.js" type="text/javascript"></script>

<!-- svg图表  supports Firefox 3.0+, Safari 3.0+, Chrome 5.0+, Opera 9.5+ and Internet Explorer 6.0+ -->
<script type="text/javascript" src="/thumb/Public/dwz/chart/raphael.js"></script>
<script type="text/javascript" src="/thumb/Public/dwz/chart/g.raphael.js"></script>
<script type="text/javascript" src="/thumb/Public/dwz/chart/g.bar.js"></script>
<script type="text/javascript" src="/thumb/Public/dwz/chart/g.line.js"></script>
<script type="text/javascript" src="/thumb/Public/dwz/chart/g.pie.js"></script>
<script type="text/javascript" src="/thumb/Public/dwz/chart/g.dot.js"></script>

<script src="/thumb/Public/dwz/js/dwz.core.js" type="text/javascript"></script>
<script src="/thumb/Public/dwz/js/dwz.util.date.js" type="text/javascript"></script>
<script src="/thumb/Public/dwz/js/dwz.validate.method.js" type="text/javascript"></script>
<script src="/thumb/Public/dwz/js/dwz.barDrag.js" type="text/javascript"></script>
<script src="/thumb/Public/dwz/js/dwz.drag.js" type="text/javascript"></script>
<script src="/thumb/Public/dwz/js/dwz.tree.js" type="text/javascript"></script>
<script src="/thumb/Public/dwz/js/dwz.accordion.js" type="text/javascript"></script>
<script src="/thumb/Public/dwz/js/dwz.ui.js" type="text/javascript"></script>
<script src="/thumb/Public/dwz/js/dwz.theme.js" type="text/javascript"></script>
<script src="/thumb/Public/dwz/js/dwz.switchEnv.js" type="text/javascript"></script>
<script src="/thumb/Public/dwz/js/dwz.alertMsg.js" type="text/javascript"></script>
<script src="/thumb/Public/dwz/js/dwz.contextmenu.js" type="text/javascript"></script>
<script src="/thumb/Public/dwz/js/dwz.navTab.js" type="text/javascript"></script>
<script src="/thumb/Public/dwz/js/dwz.tab.js" type="text/javascript"></script>
<script src="/thumb/Public/dwz/js/dwz.resize.js" type="text/javascript"></script>
<script src="/thumb/Public/dwz/js/dwz.dialog.js" type="text/javascript"></script>
<script src="/thumb/Public/dwz/js/dwz.dialogDrag.js" type="text/javascript"></script>
<script src="/thumb/Public/dwz/js/dwz.sortDrag.js" type="text/javascript"></script>
<script src="/thumb/Public/dwz/js/dwz.cssTable.js" type="text/javascript"></script>
<script src="/thumb/Public/dwz/js/dwz.stable.js" type="text/javascript"></script>
<script src="/thumb/Public/dwz/js/dwz.taskBar.js" type="text/javascript"></script>
<script src="/thumb/Public/dwz/js/dwz.ajax.js" type="text/javascript"></script>
<script src="/thumb/Public/dwz/js/dwz.pagination.js" type="text/javascript"></script>
<script src="/thumb/Public/dwz/js/dwz.database.js" type="text/javascript"></script>
<script src="/thumb/Public/dwz/js/dwz.datepicker.js" type="text/javascript"></script>
<script src="/thumb/Public/dwz/js/dwz.effects.js" type="text/javascript"></script>
<script src="/thumb/Public/dwz/js/dwz.panel.js" type="text/javascript"></script>
<script src="/thumb/Public/dwz/js/dwz.checkbox.js" type="text/javascript"></script>
<script src="/thumb/Public/dwz/js/dwz.history.js" type="text/javascript"></script>
<script src="/thumb/Public/dwz/js/dwz.combox.js" type="text/javascript"></script>
<script src="/thumb/Public/dwz/js/dwz.print.js" type="text/javascript"></script>

<!-- 可以用dwz.min.js替换前面全部dwz.*.js (注意：替换时下面dwz.regional.zh.js还需要引入)
<script src="/thumb/Public/dwz/bin/dwz.min.js" type="text/javascript"></script>
-->
<script src="/thumb/Public/dwz/js/dwz.regional.zh.js" type="text/javascript"></script>

<script type="text/javascript">
$(function(){
	DWZ.init("/thumb/dwz.frag.xml", {
				...
				<div class="toggleCollapse"><h2>主菜单</h2><div>收缩</div></div>
					...
					<div class="accordionContent">
						<ul class="tree treeFolder">
							<li><a>权限管理</a>
								<ul>
									<li><a href="<?php echo U('Auth/accessList');?>" target="navTab" rel="w_validation">权限列表</a></li>
									<li><a href="#" target="navTab" rel="w_button">角色</a></li>
									<li><a href="#" target="navTab" rel="w_textInput">权限资源</a></li>
								</ul>
							</li>
							<li><a href="tabsPage.html" target="navTab">主框架面板</a>
								<ul>
									<li><a href="main.html" target="navTab" rel="main">我的主页</a></li>
									<li><a href="http://www.hlcmj.com" target="navTab" rel="page1">页面一(外部链接)</a></li>
							...
							<li><a href="/thumb/dwz.frag.xml" target="navTab" external="true">dwz.frag.xml</a></li>
						</ul>
					</div>
					<div class="accordionHeader">
